...
test_it POST direct "" ""
# test_it_long_fail POST direct "staph" "Unknown request"#lwp-request
test_it_long_fail POST direct "staph" "Failed"
test_it_long POST direct "stop\nstart" ""
test_it_long POST direct "stop" ""
# test_it_long POST direct "start" ""
test_it POST direct "status" "Child in state stopped"
test_it_long POST direct "\t" ""
test_it_long POST direct "vcl.inline foo \"vcl 4.0;backend foo { .host = \\\"127.0.0.1\\\"; }\"" ""
# test_it_long_fail POST direct "vcl.inline foo2 \"vcl 4.0;\nbackend foo { .host = \\\"127.0.0.1\\\"; }\"" "Missing '\"'"#lwp-request
test_it_long_fail POST direct "vcl.inline foo2 \"vcl 4.0;\nbackend foo { .host = \\\"127.0.0.1\\\"; }\"" "Failed"
...
# test_it_fail POST direct "status" "Child in state stopped"
test_it POST direct "status" "Child in state stopped"
exit $ret
